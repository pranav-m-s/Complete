...
<!-- <a href="http://localhost/project/Complete/Login&Register/login_student.php">	<input  type="submit" value="Post" class="button-post" ></a> -->
				...
				$('#Table').find( 'tr:not(:first)' ).remove();
                        $.each(obj,function(index,value){
									...
									table_content += "<td>"+value.question+"</td>"; 
									  ...
									  table_content+="<td><a class='btn btn-primary' href='answer.php?id="+value.id+"'>Answer</a><button class='btn btn-danger' onclick='dele("+value.id+")'>Delete</button><button class='btn btn-info' onclick='studentView("+value.id+")'>View</button></td>";
                            table_content+="</tr>";
