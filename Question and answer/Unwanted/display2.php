...
<table id="question" >
	...
	<script type="text/javascript">
				...
				var table_content = '';
				$('#question').find( 'tr:not(:first)' ).remove();
                        $.each(obj,function(index,value){
									table_content += "<tr>";
									table_content += "<td>"+value.question+"</td>";
									  
									// Have to write a variable that takes the id
									  ...
									  table_content+="<td><a class='btn btn-primary' href='student_edit.php?id="+value.id+"'>Edit</a><button class='btn btn-danger' onclick='dele("+value.id+")'>Delete</button><button class='btn btn-info' onclick='studentView("+value.id+")'>View</button><a class='btn btn-primary href ='answer.php?id =" + value.id + "'>Answer</a></td>";
                            table_content+="</tr>";

								 
								});
								$("#question").append(table_content);
				...
				// answer_call();
						...
						// function answer_call(question_id){
       ...
       //                				    	if (alert(	question_id == value.question_id)) {
